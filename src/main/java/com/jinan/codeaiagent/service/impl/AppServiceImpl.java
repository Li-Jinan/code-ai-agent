...
import com.jinan.codeaiagent.ai.AiCodeGenTypeRoutingService;
import com.jinan.codeaiagent.ai.AiCodeGenTypeRoutingServiceFactory;
import com.jinan.codeaiagent.constant.AppConstant;
import com.jinan.codeaiagent.core.AiCodeGeneratorFacade;
import com.jinan.codeaiagent.core.builder.VueProjectBuilder;
import com.jinan.codeaiagent.core.handler.StreamHandlerExecutor;
...
import com.jinan.codeaiagent.model.dto.app.AppAddRequest;
import com.jinan.codeaiagent.model.dto.app.AppQueryRequest;
import com.jinan.codeaiagent.model.entity.App;
import com.jinan.codeaiagent.mapper.AppMapper;
import com.jinan.codeaiagent.model.entity.User;
import com.jinan.codeaiagent.model.enums.ChatHistoryMessageTypeEnum;
...
import com.jinan.codeaiagent.monitor.MonitorContext;
import com.jinan.codeaiagent.monitor.MonitorContextHolder;
import com.jinan.codeaiagent.service.AppService;
import com.jinan.codeaiagent.service.ChatHistoryService;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public String deployApp(Long appId, User loginUser) {
        ...
        // 10. 构建应用访问 URL
        String appDeployUrl = String.format("%s/%s/", StrUtil.removeSuffix(deployHost, "/"), deployKey);
        // 11. 异步生成截图并且更新应用封面
